pub struct RedisKeyConstant;

impl RedisKeyConstant {
    /*
     * 首页博客简介列表 分页对象key
     ...
     * 标签云列表key
     */
    pub const TAG_CLOUD_LIST: &str = "tagCloudList";
    /**
     * 站点信息key
     */
    pub const SITE_INFO_MAP: &str = "siteInfoMap";
    /**
     * 最新推荐博客key
     */
    ...
    //  * QQ号与对应头像URL key
    //  */
    //pub const QQ_AVATAR_URL_MAP: &str = "qqAvatarUrlMap";
}
